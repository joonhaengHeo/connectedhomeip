...
@property (nonatomic, copy) NSNumber * _Nonnull requestedProtocol MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSString * _Nullable transferFileDesignator MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
