...
#include "AndroidInteractionClientExceptions.h"
...
CHIP_ERROR AndroidInteractionClientExceptions::CreateAndroidInteractionClientException(JNIEnv * env, const char * message, uint32_t errorCode,
                                                                         jthrowable & outEx)
{
    jclass controllerExceptionCls;
    CHIP_ERROR err = JniReferences::GetInstance().GetLocalClassRef(env, "chip/devicecontroller/ChipInteractionClientException",
