...
CHIP_ERROR EncodeAttributeValue(const app::ConcreteAttributePath & aPath, jobject jValue, TLV::TLVWriter &aWriter)
{
            ...
            switch (aPath.mAttributeId)
            {
                case Attributes::IdentifyTime::Id: {
                    ...
                    TypeInfo::Type cppValue;
                            cppValue = static_cast<std::remove_reference_t<decltype(cppValue)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue));
                    ...
                    TypeInfo::Type cppValue;
                      if (jValue == nullptr) {
                        ...
                        auto & nonNullValue_0 = cppValue.SetNonNull();
                              nonNullValue_0 = static_cast<std::remove_reference_t<decltype(nonNullValue_0)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue));
  }
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
        ...
        case app::Clusters::BinaryInputBasic::Id: {
            ...
            switch (aPath.mAttributeId)
            {
                case Attributes::OutOfService::Id: {
                    ...
                    TypeInfo::Type cppValue;
                            cppValue = static_cast<std::remove_reference_t<decltype(cppValue)>>(chip::JniReferences::GetInstance().BooleanToPrimitive(jValue));
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
    ...
    chip::JniReferences::GetInstance().GetObjectField(element_0, "fabricIndex", "Ljava/lang/Integer;", element_0_fabricIndexItem_1);
            listHolder_0->mList[i_0].fabricIndex = static_cast<std::remove_reference_t<decltype(listHolder_0->mList[i_0].fabricIndex)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(element_0_fabricIndexItem_1));
                    ...
                    err = app::DataModel::EncodeForWrite(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                default:
                    err = CHIP_ERROR_IM_MALFORMED_ATTRIBUTE_PATH_IB;
        ...
        case app::Clusters::GeneralCommissioning::Id: {
            ...
            switch (aPath.mAttributeId)
            {
                case Attributes::Breadcrumb::Id: {
                    ...
                    TypeInfo::Type cppValue;
                            cppValue = static_cast<std::remove_reference_t<decltype(cppValue)>>(chip::JniReferences::GetInstance().LongToPrimitive(jValue));
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                default:
                ...
                case Attributes::LifetimeRunningHours::Id: {
                    ...
                    TypeInfo::Type cppValue;
                      if (jValue == nullptr) {
                        ...
                        auto & nonNullValue_0 = cppValue.SetNonNull();
                                nonNullValue_0 = static_cast<std::remove_reference_t<decltype(nonNullValue_0)>>(chip::JniReferences::GetInstance().LongToPrimitive(jValue));
  }
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
    ...
    chip::JniReferences::GetInstance().GetObjectField(jValue, "application", "Lchip/devicecontroller/ChipStructs$ApplicationLauncherClusterApplication;", jValue_applicationItem_1);
        jobject jValue_applicationItem_1_catalogVendorIdItem_2;
    chip::JniReferences::GetInstance().GetObjectField(jValue_applicationItem_1, "catalogVendorId", "Ljava/lang/Integer;", jValue_applicationItem_1_catalogVendorIdItem_2);
            nonNullValue_0.application.catalogVendorId = static_cast<std::remove_reference_t<decltype(nonNullValue_0.application.catalogVendorId)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_applicationItem_1_catalogVendorIdItem_2));
    jobject jValue_applicationItem_1_applicationIdItem_2;
    chip::JniReferences::GetInstance().GetObjectField(jValue_applicationItem_1, "applicationId", "Ljava/lang/String;", jValue_applicationItem_1_applicationIdItem_2);
      cleanupStrings.push_back(chip::Platform::MakeUnique<chip::JniUtfString>(env, static_cast<jstring>(jValue_applicationItem_1_applicationIdItem_2)));
      nonNullValue_0.application.applicationId = cleanupStrings.back()->charSpan();
    jobject jValue_endpointItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "endpoint", "Ljava/util/Optional;", jValue_endpointItem_1);
        ...
        case app::Clusters::UnitTesting::Id: {
            ...
            switch (aPath.mAttributeId)
            {
                ...
                case Attributes::FloatSingle::Id: {
                    ...
                    TypeInfo::Type cppValue;
                            cppValue = static_cast<std::remove_reference_t<decltype(cppValue)>>(chip::JniReferences::GetInstance().FloatToPrimitive(jValue));
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                case Attributes::FloatDouble::Id: {
                    ...
                    TypeInfo::Type cppValue;
                            cppValue = static_cast<std::remove_reference_t<decltype(cppValue)>>(chip::JniReferences::GetInstance().DoubleToPrimitive(jValue));
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
    ...
    chip::JniReferences::GetInstance().GetObjectField(jValue, "a", "Ljava/lang/Integer;", jValue_aItem_0);
            cppValue.a = static_cast<std::remove_reference_t<decltype(cppValue.a)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_aItem_0));
    jobject jValue_bItem_0;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "b", "Ljava/lang/Boolean;", jValue_bItem_0);
            cppValue.b = static_cast<std::remove_reference_t<decltype(cppValue.b)>>(chip::JniReferences::GetInstance().BooleanToPrimitive(jValue_bItem_0));
    jobject jValue_cItem_0;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "c", "Ljava/lang/Integer;", jValue_cItem_0);
          cppValue.c = static_cast<std::remove_reference_t<decltype(cppValue.c)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_cItem_0));
    jobject jValue_dItem_0;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "d", "[B", jValue_dItem_0);
      cleanupByteArrays.push_back(chip::Platform::MakeUnique<chip::JniByteArray>(env, static_cast<jbyteArray>(jValue_dItem_0)));
    ...
    chip::JniReferences::GetInstance().GetObjectField(jValue, "f", "Ljava/lang/Integer;", jValue_fItem_0);
            cppValue.f = static_cast<std::remove_reference_t<decltype(cppValue.f)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_fItem_0));
    jobject jValue_gItem_0;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "g", "Ljava/lang/Float;", jValue_gItem_0);
            cppValue.g = static_cast<std::remove_reference_t<decltype(cppValue.g)>>(chip::JniReferences::GetInstance().FloatToPrimitive(jValue_gItem_0));
    jobject jValue_hItem_0;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "h", "Ljava/lang/Double;", jValue_hItem_0);
            cppValue.h = static_cast<std::remove_reference_t<decltype(cppValue.h)>>(chip::JniReferences::GetInstance().DoubleToPrimitive(jValue_hItem_0));
                    err = app::DataModel::EncodeForWrite(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                ...
                case Attributes::NullableBoolean::Id: {
                    ...
                    TypeInfo::Type cppValue;
                      if (jValue == nullptr) {
                        ...
                        auto & nonNullValue_0 = cppValue.SetNonNull();
                                nonNullValue_0 = static_cast<std::remove_reference_t<decltype(nonNullValue_0)>>(chip::JniReferences::GetInstance().BooleanToPrimitive(jValue));
  }
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                ...
                case Attributes::NullableFloatSingle::Id: {
                    ...
                    TypeInfo::Type cppValue;
                      if (jValue == nullptr) {
                        ...
                        auto & nonNullValue_0 = cppValue.SetNonNull();
                                nonNullValue_0 = static_cast<std::remove_reference_t<decltype(nonNullValue_0)>>(chip::JniReferences::GetInstance().FloatToPrimitive(jValue));
  }
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
                case Attributes::NullableFloatDouble::Id: {
                    ...
                    TypeInfo::Type cppValue;
                      if (jValue == nullptr) {
                        ...
                        auto & nonNullValue_0 = cppValue.SetNonNull();
                                nonNullValue_0 = static_cast<std::remove_reference_t<decltype(nonNullValue_0)>>(chip::JniReferences::GetInstance().DoubleToPrimitive(jValue));
  }
                    err = app::DataModel::Encode(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
    ...
    chip::JniReferences::GetInstance().GetObjectField(jValue, "a", "Ljava/lang/Integer;", jValue_aItem_1);
            nonNullValue_0.a = static_cast<std::remove_reference_t<decltype(nonNullValue_0.a)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_aItem_1));
    jobject jValue_bItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "b", "Ljava/lang/Boolean;", jValue_bItem_1);
            nonNullValue_0.b = static_cast<std::remove_reference_t<decltype(nonNullValue_0.b)>>(chip::JniReferences::GetInstance().BooleanToPrimitive(jValue_bItem_1));
    jobject jValue_cItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "c", "Ljava/lang/Integer;", jValue_cItem_1);
          nonNullValue_0.c = static_cast<std::remove_reference_t<decltype(nonNullValue_0.c)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_cItem_1));
    jobject jValue_dItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "d", "[B", jValue_dItem_1);
      cleanupByteArrays.push_back(chip::Platform::MakeUnique<chip::JniByteArray>(env, static_cast<jbyteArray>(jValue_dItem_1)));
    ...
    chip::JniReferences::GetInstance().GetObjectField(jValue, "f", "Ljava/lang/Integer;", jValue_fItem_1);
            nonNullValue_0.f = static_cast<std::remove_reference_t<decltype(nonNullValue_0.f)>>(chip::JniReferences::GetInstance().IntegerToPrimitive(jValue_fItem_1));
    jobject jValue_gItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "g", "Ljava/lang/Float;", jValue_gItem_1);
            nonNullValue_0.g = static_cast<std::remove_reference_t<decltype(nonNullValue_0.g)>>(chip::JniReferences::GetInstance().FloatToPrimitive(jValue_gItem_1));
    jobject jValue_hItem_1;
    chip::JniReferences::GetInstance().GetObjectField(jValue, "h", "Ljava/lang/Double;", jValue_hItem_1);
            nonNullValue_0.h = static_cast<std::remove_reference_t<decltype(nonNullValue_0.h)>>(chip::JniReferences::GetInstance().DoubleToPrimitive(jValue_hItem_1));
  }
                    err = app::DataModel::EncodeForWrite(aWriter, TLV::ContextTag(to_underlying(app::AttributeDataIB::Tag::kData)), cppValue);
                    return err;
                }
