...
jobject DecodeEventValue(const app::ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    value_latestValue = env->NewObject(accessControlEntryStructClass_1, accessControlEntryStructCtor_1
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), cppValue.fabricIndex, value_fabricIndex);
                    ...
                    jmethodID accessControlEntryChangedStructCtor = env->GetMethodID(accessControlEntryChangedStructClass, "<init>"
                        , "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Lchip/devicecontroller/ChipStructs$AccessControlClusterAccessControlEntry;Ljava/lang/Integer;)V");
    ...
    value_latestValue = env->NewObject(extensionEntryStructClass_1, extensionEntryStructCtor_1
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), cppValue.fabricIndex, value_fabricIndex);
                    ...
                    jmethodID accessControlExtensionChangedStructCtor = env->GetMethodID(accessControlExtensionChangedStructClass, "<init>"
                        , "(Ljava/lang/Long;Ljava/lang/Integer;Ljava/lang/Integer;Lchip/devicecontroller/ChipStructs$AccessControlClusterExtensionEntry;Ljava/lang/Integer;)V");
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_errorClassName.c_str(), value_errorCtorSignature.c_str(), static_cast<uint8_t>(cppValue.error), value_error);
        ...
        std::string value_softwareVersionCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_softwareVersionClassName.c_str(), value_softwareVersionCtorSignature.c_str(), cppValue.softwareVersion, value_softwareVersion);
                    ...
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicClusterStartUpEvent", startUpStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::ShutDown::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicClusterShutDownEvent", shutDownStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_fabricIndexCtorSignature = "(I)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_fabricIndexClassName.c_str(), value_fabricIndexCtorSignature.c_str(), cppValue.fabricIndex, value_fabricIndex);
                    ...
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicClusterLeaveEvent", leaveStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_reachableNewValueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_reachableNewValueClassName.c_str(), value_reachableNewValueCtorSignature.c_str(), cppValue.reachableNewValue, value_reachableNewValue);
                    ...
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BasicClusterReachableChangedEvent", reachableChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
          ...
          chip::JniReferences::GetInstance().CreateBoxedObject<uint64_t>(value_idClassName.c_str(), value_idCtorSignature.c_str(), cppValue.id, value_id);
                    ...
                    if (!cppValue.name.HasValue()) {
                      ...
                      jobject value_nameInsideOptional;
                              value_nameInsideOptional = env->NewStringUTF(std::string(cppValue.name.Value().data(), cppValue.name.Value().size()).c_str());
  ...
  chip::JniReferences::GetInstance().CreateOptional(value_faultRecordingInsideOptional, value_faultRecording);
      ...
      chip::JniReferences::GetInstance().CreateBoxedObject<uint8_t>(value_connectionStatusClassName.c_str(), value_connectionStatusCtorSignature.c_str(), static_cast<uint8_t>(cppValue.connectionStatus), value_connectionStatus);
        ...
        std::string value_softwareVersionCtorSignature = "(J)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<uint32_t>(value_softwareVersionClassName.c_str(), value_softwareVersionCtorSignature.c_str(), cppValue.softwareVersion, value_softwareVersion);
                    ...
                    jclass startUpStructClass;
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicClusterStartUpEvent", startUpStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::ShutDown::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jclass shutDownStructClass;
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicClusterShutDownEvent", shutDownStructClass);
                    if (err != CHIP_NO_ERROR) {
                ...
                case Events::Leave::Id: {
                    ...
                    *aError = app::DataModel::Decode(aReader, cppValue);
                    ...
                    jclass leaveStructClass;
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicClusterLeaveEvent", leaveStructClass);
                    if (err != CHIP_NO_ERROR) {
        ...
        std::string value_reachableNewValueCtorSignature = "(Z)V";
          chip::JniReferences::GetInstance().CreateBoxedObject<bool>(value_reachableNewValueClassName.c_str(), value_reachableNewValueCtorSignature.c_str(), cppValue.reachableNewValue, value_reachableNewValue);
                    ...
                    jclass reachableChangedStructClass;
                    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipEventStructs$BridgedDeviceBasicClusterReachableChangedEvent", reachableChangedStructClass);
                    if (err != CHIP_NO_ERROR) {
    ...
    err = chip::JniReferences::GetInstance().GetClassRef(env, "chip/devicecontroller/ChipStructs$DoorLockClusterDlCredential", dlCredentialStructClass_3);
    if (err != CHIP_NO_ERROR) {
      ChipLogError(Zcl, "Could not find class ChipStructs$DoorLockClusterDlCredential");
      return nullptr;
    }
    jmethodID dlCredentialStructCtor_3 = env->GetMethodID(dlCredentialStructClass_3, "<init>"
        , "(Ljava/lang/Integer;Ljava/lang/Integer;)V");
