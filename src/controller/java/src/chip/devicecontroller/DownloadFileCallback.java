...
/** An interface for receiving download File response. */
public interface DownloadFileCallback {
  /**
   * OnError will be called when the File download fails.
   *
  ...
  /**
   * onSuccess will be called when the File download is complete.
   *
   * @param fabricIndex The fabric index of to which the node belongs
   * @param nodeId The Node ID of the target device.
   */
