...
object Switch : BaseCluster() {
  ...
  sealed class Event(val id: Long, val name: String) {
    object SwitchLatched : Event(0L, "SwitchLatched")

    object InitialPress : Event(1L, "InitialPress")

    object LongPress : Event(2L, "LongPress")

    object ShortRelease : Event(3L, "ShortRelease")

    object LongRelease : Event(4L, "LongRelease")

    object MultiPressOngoing : Event(5L, "MultiPressOngoing")

    object MultiPressComplete : Event(6L, "MultiPressComplete")
