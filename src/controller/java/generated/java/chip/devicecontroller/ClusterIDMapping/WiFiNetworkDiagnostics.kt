...
object WiFiNetworkDiagnostics : BaseCluster() {
  const val ID = 54L
  ...
  sealed class Event(val id: Long, val name: String) {
    object Disconnection : Event(0L, "Disconnection")

    object AssociationFailure : Event(1L, "AssociationFailure")

    object ConnectionStatus : Event(2L, "ConnectionStatus")
