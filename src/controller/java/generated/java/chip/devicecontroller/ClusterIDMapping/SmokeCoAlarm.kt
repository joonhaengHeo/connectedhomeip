...
object SmokeCoAlarm : BaseCluster() {
  const val ID = 92L
  ...
  sealed class Event(val id: Long, val name: String) {
    object SmokeAlarm : Event(0L, "SmokeAlarm")

    object COAlarm : Event(1L, "COAlarm")

    object LowBattery : Event(2L, "LowBattery")

    object HardwareFault : Event(3L, "HardwareFault")

    object EndOfService : Event(4L, "EndOfService")

    object SelfTestComplete : Event(5L, "SelfTestComplete")

    object AlarmMuted : Event(6L, "AlarmMuted")

    object MuteEnded : Event(7L, "MuteEnded")

    object InterconnectSmokeAlarm : Event(8L, "InterconnectSmokeAlarm")

    object InterconnectCOAlarm : Event(9L, "InterconnectCOAlarm")

    object AllClear : Event(10L, "AllClear")
  ...
  sealed class Command(val id: Long, val name: String) {
    object SelfTestRequest : Command(0L, "SelfTestRequest")
