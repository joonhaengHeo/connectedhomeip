...
object GroupKeyManagement : BaseCluster() {
  const val ID = 63L
  ...
  sealed class Command(val id: Long, val name: String) {
    object KeySetWrite : Command(0L, "KeySetWrite")

    object KeySetRead : Command(1L, "KeySetRead")

    object KeySetRemove : Command(3L, "KeySetRemove")

    object KeySetReadAllIndices : Command(4L, "KeySetReadAllIndices")
  ...
  sealed class KeySetWriteCommandField(val id: Int, val name: String) {
    object GroupKeySet : KeySetWriteCommandField(0, "GroupKeySet")

    companion object {
      fun values(): List<KeySetWriteCommandField> {
        return KeySetWriteCommandField::class.sealedSubclasses.map { it.objectInstance!! }
      }
      ...
      @Throws(IllegalArgumentException::class)
      fun valueOf(value: String): KeySetWriteCommandField {
        for (field in values()) {
          if (field.name == value) {
            return field
          }
  ...
  sealed class KeySetReadCommandField(val id: Int, val name: String) {
    object GroupKeySetID : KeySetReadCommandField(0, "GroupKeySetID")

    companion object {
      fun values(): List<KeySetReadCommandField> {
        return KeySetReadCommandField::class.sealedSubclasses.map { it.objectInstance!! }
      }
      ...
      @Throws(IllegalArgumentException::class)
      fun valueOf(value: String): KeySetReadCommandField {
        for (field in values()) {
          if (field.name == value) {
            return field
          }
  ...
  sealed class KeySetRemoveCommandField(val id: Int, val name: String) {
    object GroupKeySetID : KeySetRemoveCommandField(0, "GroupKeySetID")

    companion object {
      fun values(): List<KeySetRemoveCommandField> {
        return KeySetRemoveCommandField::class.sealedSubclasses.map { it.objectInstance!! }
      }
      ...
      @Throws(IllegalArgumentException::class)
      fun valueOf(value: String): KeySetRemoveCommandField {
        for (field in values()) {
          if (field.name == value) {
            return field
          }
